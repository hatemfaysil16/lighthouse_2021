...
<section id="video" class="video">
  <div class="container">
      ...
      <div class="card" style="width: 22rem;margin:auto">
        ...
        <div class="card-body">
        <h5 class="card-title">Light House ERB</h5>
        <p class="card-text">{{__('company.video_paragraph')}}</p>
        <a target="__blank" href="https://www.youtube.com/channel/UCs1TJvJ9xg5PwrgTRikJV_w"class="btn btn-primary"><strong>YouTube</strong></a>
        </div>
      </div>
